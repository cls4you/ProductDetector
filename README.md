...
Датасет состоит из фотографий продуктов, снятых с различных ракурсов для обеспечения разнообразия визуальных представлений, и их ручной разметки. К исходным изображениям была применена аугментация, включая повороты, изменения яркости, масштабирование и добавление шума, что значительно увеличило объём и вариативность данных. Итоговый размер датасета состовляет 1500 вариантов аугментированных фотографий.
